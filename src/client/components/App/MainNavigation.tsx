...
export const MainNavigation: React.FC = () => {
  ...
  return (
    <nav className="main-navigation">
      <a className="content-box main-navigation__brand" href="/">
        REKI
      </a>
      <div className="content-box" />
      {navItems.map((navItem, i) =>
        navItem.spacer ? (
          <div key={i} className="main-navigation__stretch-spacer" />
        ) : (
          <NavigationItem
            className="content-box main-navigation__navigation-item"
            key={navItem.label}
            values={navItem}
          />
        ),
...
): MaybeSpacer<NavigationItemValue>[] {
