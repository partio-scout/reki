...
const QuickFilterControl: React.FC<QuickFilterControlProps> = ({
  filter,
  updateFilter,
  currentSelection,
  availableDates,
...
const QuickFilterGroup: React.FC = ({ children }) => (
  <div className="quick-filter-container__group">{children}</div>
)
...
export const QuickFilterContainer: React.FC<QuickFilterContainerProps> = (
  props,
) => {
