...
type MassEditProps = Readonly<{
  ...
  setChecked: (checkedParticipants: readonly ParticipantOverview['participantId'][]) => void;
  participantsLoading: boolean;
}>

export const MassEdit: React.FC<MassEditProps> = ({ onSubmit, checked, participants, setChecked, participantsLoading }) => {
  ...
  const handleChange = (p: unknown, newValue: number | undefined) => setValue(newValue);
