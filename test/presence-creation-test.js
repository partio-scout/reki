...
describe('Participant change event', () => {
  ...
  it('Should have multiple presenceHistories', () => updateAllParticipants({ participantId: id }, { inCamp: 0 })
      .then(() => updateAllParticipants({ participantId: id }, { inCamp: 2 })
          .then(() => updateAllParticipants({ participantId: id }, { inCamp: 0 })
            .then(() => updateAllParticipants({ participantId: id }, { inCamp: 2 }))
      )
